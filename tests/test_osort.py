...
def test_osort_preserve_crlf_endlines_bytes():
    original = b"a = b\r\nb = 4"
    expected = b"b = 4\r\na = b\r\n"
...
def test_osort_preserve_crlf_endlines_str():
    original = "a = b\r\nb = 4"
    expected = "b = 4\r\na = b\r\n"
...
def test_osort_list_comp_conflicts_with_global_scope():
    original = _clean(
        """
        def f():
            g()
...
def test_osort_set_comp_conflicts_with_global_scope():
    original = _clean(
        """
        def f():
            g()
...
def test_osort_dict_comp_conflicts_with_global_scope():
    original = _clean(
        """
        def f():
            g()
...
def test_osort_generator_exp_conflicts_with_global_scope():
    original = _clean(
        """
        def f():
            g()
...
def test_osort_self_positional_only():
    original = _clean(
        """
        class C:
...
@type_parameter_syntax
def test_osort_generic_function():
    original = _clean(
        """
        func(4)
        def func[T](a: T) -> T:
